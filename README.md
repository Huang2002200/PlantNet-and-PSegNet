...
* folder [**models**] contains the code for PlantNet's entire training and testing processes.<br>
  ...
  * we also provide a trained PyTorch PlantNet model at epoch 200; the model parameters were saved into a file "PlantNet/PlantNet_pytorch/models/checkpoints/model_epoch199.pth".<br>
### PSegNet<br>
