...
target_folder = '/path/to/target/folder'   # trainset_dir or testset_dir
...
all_files_number = 546
selected_files_number = 364   # train files number  (182 if test)
random_numbers = random.sample(range(all_files_number+1), selected_files_number)
